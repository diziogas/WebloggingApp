  ...
  <body>
    <div class="container" style="margin-top:10%">
      ...
      <form action="Login" method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="usernameLogin" aria-describedby="emailHelp" placeholder="Enter username">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Password</label>
          <input type="password" class="form-control" name="passwordLogin" placeholder="Password">
        </div>
        <button id="signIn" class="btn btn-primary">Submit</button>
      </form>
    </div> 
    ...
    <div class="container" style="margin-top:5%;padding-bottom:5%;">
      ...
      <form action="Register" method="post">
        <div class="form-group">
          <label for="exampleInputEmail1">Username</label>
          <input type="text" class="form-control" name="usernameSignUp" aria-describedby="emailHelp" placeholder="Enter username">
        </div>
